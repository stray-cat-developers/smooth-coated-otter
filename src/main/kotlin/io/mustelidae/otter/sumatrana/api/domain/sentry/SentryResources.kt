    ...
    data class Payload (
        ...
        data class Data(
            ...
            data class Event(
                ...
                @JsonProperty("exception") val exception: Exception? = null,
                @JsonProperty("fingerprint") val fingerprint: ArrayList<String>? = arrayListOf(),
                @JsonProperty("grouping_config") val groupingConfig: GroupingConfig? = null,
                @JsonProperty("hashes") val hashes: ArrayList<String>? = arrayListOf(),
